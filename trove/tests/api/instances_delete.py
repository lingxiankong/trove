...
class TestDeleteInstance(object):
    ...
    def test_delete_datastore_version(self):
        ...
        datastore = dbaas_admin.datastores.get('Test_Datastore_1')
        ds_version = dbaas_admin.datastore_versions.list(datastore.id)[0]
        dbaas_admin.mgmt_datastore_versions.delete(ds_version.id)
